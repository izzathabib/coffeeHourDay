...
<div class="card text-center">
  <div class="card-body">
    ...
    <h1>THANK YOU!</h1>
    <p class="successFeedbackMessage">We've received your feedback</p>
  </div>
</div>
@endsection